class Weave < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/initia-labs/weave/releases/download/v0.0.4/weave_v0.0.4_darwin_arm64.tar.gz"
    sha256 "c80e23db9df9947303c31da8f778b47cbfdcabdf7d069094e467c3b9c1f79b63"
  else
    url "https://github.com/initia-labs/weave/releases/download/v0.0.4/weave_v0.0.4_darwin_amd64.tar.gz"
